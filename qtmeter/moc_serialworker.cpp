...
QT_MOC_LITERAL(1, 13, 13), // "levelReceived"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 5), // "level"
QT_MOC_LITERAL(4, 34, 12), // "reverseOrder"
QT_MOC_LITERAL(5, 47, 15) // "handleReadyRead"

    },
    "SerialWorker\0levelReceived\0\0level\0"
    "reverseOrder\0handleReadyRead"
};
...
void SerialWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->levelReceived((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        ...
        {
            using _t = void (SerialWorker::*)(int , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialWorker::levelReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialWorker::levelReceived(int _t1, bool _t2)
{
